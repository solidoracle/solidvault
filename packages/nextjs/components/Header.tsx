    ...
    <div className="sticky lg:static top-0 navbar bg-base-100 min-h-0 flex-shrink-0 justify-between z-20 shadow-md shadow-secondary">
      <div className="navbar-start w-auto lg:w-1/2">
        ...
        <div className="hidden lg:flex items-center gap-2 ml-4 mr-6">
          <Link href="/" passHref className="flex relative w-6 h-6">
            <Image alt="SolidVault" className="cursor-pointer" fill src="/solidvault.png" />
          </Link>
          <div className="flex flex-col">
            <span className="font-bold leading-tight">SOLIDVAULT</span>
          </div>
        </div>
